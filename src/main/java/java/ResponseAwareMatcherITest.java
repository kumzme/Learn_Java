...
public class ResponseAwareMatcherITest extends WithJetty {
    ...
    can_use_response_aware_matcher_to_construct_hamcrest_matcher_with_data_from_response_with_predefined_matcher() {
        ...
        then().
                statusCode(200).
                body("_links.self.href", RestAssuredMatchers.endsWithPath("id")).
                body("status", equalTo("ongoing"));
    }
    ...
    response_aware_matchers_are_composable_with_hamcrest_matchers() {
        ...
        then().
                statusCode(200).
                body("_links.self.href", ResponseAwareMatcherComposer.and(RestAssuredMatchers.endsWithPath("id"), anyOf(startsWith("http://localhost:8081"), containsString("localhost")), response -> containsString(response.path("id")))).
                body("status", equalTo("ongoing"));
    }
    ...
    and_using_hamcrest_matchers_are_composable_with_response_aware_matchers() {
        ...
        then().
                statusCode(200).
                body("_links.self.href", ResponseAwareMatcherComposer.and(startsWith("http://localhost:8080"), RestAssuredMatchers.endsWithPath("id"))).
                body("status", equalTo("ongoing"));
    }
    ...
    or_using_hamcrest_matchers_are_composable_with_response_aware_matchers() {
        ...
        then().
                statusCode(200).
                body("_links.self.href", ResponseAwareMatcherComposer.or(startsWith("http://localhost:8081"), RestAssuredMatchers.endsWithPath("_links.self.href"))).
                body("status", equalTo("ongoing"));
    }
    ...
    response_aware_matchers_are_composable_with_other_response_aware_matchers() {
        ...
        then().
                statusCode(200).
                body("_links.self.href", ResponseAwareMatcherComposer.and(RestAssuredMatchers.endsWithPath("id"), response -> containsString("localhost"))).
                body("status", equalTo("ongoing"));
    }
